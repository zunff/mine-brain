...
* **长期记忆与认知沉淀**：价值观、人生阶段焦点、反复纠结、重大决定及其复盘，带完整时间轴沉淀在本地单文件数据库。
...
* **多维认知探针**：每次回复显式展示本轮调用的认知依据——我的底色、打对台的过去想法、反复绕不开的事、想法的演变，透明可见。
...
| 实体类型 | 含义与定位 |
| :--- | :--- |
| **profile** / **value** | **我的底色**：我是谁、做决定的方式、底层价值观排序（新决定取代旧决定，旧版本封口留档）。 |
| **claim** | **主张与信念**：对事物的判断，带生效区间，可被 supersede / contradict。 |
| **decision** | **重要决定**：决定内容 + 决策理由 + 后续复盘状态。 |
| **question** | **未解心结**：反复出现的纠结与未解课题，长期追踪。 |
